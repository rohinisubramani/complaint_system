...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-%t9g@b7)cf3#5l20$88^28$rj+s#md)epp+pp40zxe!)lx9-5f')
...
MONGO_DB_NAME = os.getenv('MONGO_DB_NAME', 'complaint_system_db')
